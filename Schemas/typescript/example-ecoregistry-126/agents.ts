...
{
  {
    id: "7777-8888-9999-4141"; // activity owner
    attributes: [
      {
        key: "id_00054",
        value: "472799-5",
      ...
      {
        // Central Registration System number 0457059777800001
      },
    ];
  ...
  {
    id: "1234-1234-1234-1234"; // activity developer (service provider to the activity owner)
    attributes: [
      // {
      //   key: "id_00000",
  ...
  {
    // Cercarbono Certified Carbon Standard (as a legal entity who can issue attestations).
    id: "3577-3577-3578-3574";
  }

  {
    // 4K Earth Science Private Limited // The monitoring period result verifier(s).
  }
